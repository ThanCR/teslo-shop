                                    ...
                                    {availableSizes.map((size) => (
                                        ...
                                        >
                                            ...
                                            <button
                                                ...
                                                type="button"
                                                className="ml-2 text-blue-600 hover:text-blue-800 transition-colors duration-200 p-1.5">
                                                <X className="h-3 w-3" />
                                            </button>
                                        </span>
                                    ))}
                                        ...
                                        <button
                                            ...
                                            className={
                                                cn("px-3 py-1 rounded-full text-sm font-medium transition-all duration-200",
                                                    {
                                                        'bg-slate-100 text-slate-400 cursor-not-allowed': selectedSizes.includes(size),
                                                        'bg-slate-200 text-slate-700 hover:bg-slate-300 cursor-pointer': !selectedSizes.includes(size)
                                                    }
                                                )
                                            }
                                        >
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-2">
                                    ...
                                    />
                                    <Button className="px-4 py-5 rounded-lg" onClick={addTag}>
